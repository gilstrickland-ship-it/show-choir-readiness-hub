...
- [X] T143f Parent-surface tap targets (Wave-14 measured, globals.css): `.itinerary-links a` 24.8px, `.token-footer a` 36.3px (four links, every page), absence `select` 36.4px, link-help email input 41.2px. Wave 14 verified three rules take all four to 44px with no overflow regression — see its report.
